...
![image-20220407145213654](https://penguinbucket.obs.cn-southwest-2.myhuaweicloud.com/img/image-20220407145213654.png)

`row-reverse`：主轴方向从右到左

![image-20220407145325101](https://penguinbucket.obs.cn-southwest-2.myhuaweicloud.com/img/image-20220407145325101.png)

`column`：主轴方向从上到下

![image-20220407145418739](https://penguinbucket.obs.cn-southwest-2.myhuaweicloud.com/img/image-20220407145418739.png)

`column-reverse`：主轴方向从下到上

![image-20220407145456228](https://penguinbucket.obs.cn-southwest-2.myhuaweicloud.com/img/image-20220407145456228.png)
...
![image-20220407150021506](https://penguinbucket.obs.cn-southwest-2.myhuaweicloud.com/img/image-20220407150021506.png)

`flex-end`：项目位于容器的结尾

![image-20220407150104185](https://penguinbucket.obs.cn-southwest-2.myhuaweicloud.com/img/image-20220407150104185.png)

`center`：项目位于容器的中央

![image-20220407150132120](https://penguinbucket.obs.cn-southwest-2.myhuaweicloud.com/img/image-20220407150132120.png)

`space-between`：平分容器空间，首尾项目位于容器两侧

![image-20220407150208815](https://penguinbucket.obs.cn-southwest-2.myhuaweicloud.com/img/image-20220407150208815.png)

`space-around`：平分容器空间，首尾项目与容器的距离，等于其他相邻容器距离的一半

![image-20220407151419111](https://penguinbucket.obs.cn-southwest-2.myhuaweicloud.com/img/image-20220407151419111.png)
...
![image-20220407152141025](https://penguinbucket.obs.cn-southwest-2.myhuaweicloud.com/img/image-20220407152141025.png)

`flex-end`：项目位于容器的结尾

![image-20220407152222786](https://penguinbucket.obs.cn-southwest-2.myhuaweicloud.com/img/image-20220407152222786.png)

`center`：项目位于容器的中央

![image-20220407152314975](https://penguinbucket.obs.cn-southwest-2.myhuaweicloud.com/img/image-20220407152314975.png)

`baseline`：根据项目的第一行文字的基线对齐

![image-20220407152928051](https://penguinbucket.obs.cn-southwest-2.myhuaweicloud.com/img/image-20220407152928051.png)
...
![image-20220407153158367](https://penguinbucket.obs.cn-southwest-2.myhuaweicloud.com/img/image-20220407153158367.png)
